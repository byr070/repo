 ...
 */
class Autologin_usuario extends CI_Model
{
	private $table_name			= 'autologin_usuario';
	private $users_table_name	= 'usuarios';
	...
	{
		$this->db->select($this->users_table_name.'.usu_id');
		$this->db->from($this->users_table_name);
		$this->db->join($this->table_name, $this->table_name.'.user_id = '.$this->users_table_name.'.usu_id');
