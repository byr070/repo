...
|--------------------------------------------------------------------------
*/
$config['website_name'] = 'Tesis';
$config['webmaster_email'] = 'byron.144@gmail.com';
...
$config['login_max_attempts_banned'] = 8;
...
|--------------------------------------------------------------------------
*/
$config['captcha_path'] = 'static/';
$config['captcha_fonts_path'] = 'static/fonts/5.ttf';
